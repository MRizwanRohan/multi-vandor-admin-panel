<!-- ═══════════════════════════════════════════════════════════════════ -->
<!-- Area Chart Component — Reusable area chart with Chart.js -->
<!-- ═══════════════════════════════════════════════════════════════════ -->
...
// Default colors with gradient-ready backgrounds
const defaultColors = [
...
// Chart data — always fill to make it an area chart
const chartData = computed<ChartData<'line'>>(() => ({
  ...
  datasets: props.datasets.map((dataset, index) => ({
    ...
    backgroundColor: dataset.backgroundColor || defaultColors[index % defaultColors.length]?.background || 'rgba(99, 102, 241, 0.2)',
    fill: true,
